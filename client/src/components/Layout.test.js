...
jest.mock('./Header', () => () => <div>Header</div>); // Mock Header component
jest.mock('./Footer', () => () => <div>Footer</div>); // Mock Footer component
...
describe('Layout', () => {
    it('should set the meta tags and title correctly', () => {
        ...
        // Check the global document object for the title and meta tags
